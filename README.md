...
#### `file`
  ...
  **default**: none
  ...
  This file is added to the list of files specifid in `[bumpversion:file:…]`
  sections from the configuration file. If you want to rewrite only this file
  use `--no-configured-files`.
